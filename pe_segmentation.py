...
from models import (AttnBlocks, DenseTransform, PatchEmbed,
                    SegFormerHead, PeModel_Forseg)
...
def main(args):
    ...
    if dataset_name == 'GID':
        ...
        # build model
        tokenizer = PatchEmbed(patch_size=16, with_cls_token=False)
        ...
        model = PeModel_Forseg(tokenizer, backbone, denseTransform, taskHead)
        model.cuda()
